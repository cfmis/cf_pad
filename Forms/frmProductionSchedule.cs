    ...
    public partial class frmProductionSchedule : Form
    {
                        ...
                        else
                        {
                            if (con_type == 4)//未開始生產的記錄
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        sql += " And a.prd_mo like " + "'%" + txtFindMo.Text + "%'";
                                        //sql += " And a.prd_end_time = " + "'" + "" + "'";
                                        sql += " Order By a.amtim Desc,a.crtim Desc ";
                                    }
                                    else
        ...
        private void getMoDataSource()
        {
            ...
            else
            {
                ...
                if (dtArrange.Rows.Count > 0)//如果存在排單記錄
                {
                    ...
                    mktPrdPdate.Text = dr["arrange_date"].ToString();//安排日期使用PMC的排單日期
                }
                else////如果在安排的計劃中找不到，則直接在計劃單中查找
                {
        ...
        {
            if (btnFind.Text == "記錄查詢(&F)")
            {
                btnFind.Text = "記錄編輯(&F)";
                tabControl1.SelectedIndex = 1;
                BTNNOCOMP.Visible = true;
                BTNNOSTART.Visible = true;
        ...
        private void SetControlVisible()
        {
            ...
            lblDifficulty_level.Visible = t2;
            txtDifficulty_level.Visible = t2;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            objModel.prd_dep = cmbProductDept.SelectedValue.ToString().Trim();
        ...
        private void txtFindMo_TextChanged(object sender, EventArgs e)
        {
            if (txtFindMo.Text.Trim().Length >= 6)
            {
