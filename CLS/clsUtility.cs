...
namespace cf_pad.CLS
{
    public class clsUtility
    {
        ...
        //日期轉字符格式
        public static string changeDateFormat(DateTime dat)
        {
            string dateStr = dat.ToString("yyyy/MM/dd");
            return dateStr;
        }
        //日期時間轉字符格式
        public static string changeDateTimeFormat(DateTime dat)
        {
            string dateStr = dat.ToString("yyyy/MM/dd hh:mm:ss");
            return dateStr;
        }
        ...
        /// <returns>图片</returns>
        public Bitmap GenByZXingNet(string strMsg)
        {
            string msg = "https://crm.chingfung.com:8443/art/Artwork/ProductCart/" + strMsg.Trim();
