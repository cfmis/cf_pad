...
namespace cf_pad.CLS
{
    public class clsValidRule
    {
        ...
        //檢查輸入是否整數類型
        public static string validInputInt(string value)
        {
            string result = "";
            if (value.Trim() == "")
                result = "數值不能為空!";
        ...
        //檢查輸入是否數值類型
        public static string validInputNumeric(string value)
        {
            string result = "";
            if (value.Trim() == "")
                result = "數值不能為空!";
            try
            {
                decimal numx = Convert.ToDecimal(value.Trim());
            }
            catch (Exception ex)
            {
                result = "數值輸入不正確!";
